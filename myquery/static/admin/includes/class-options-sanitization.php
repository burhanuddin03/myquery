...
function of_sanitize_multicheck( $input, $option ) {
	$output = '';
	if ( is_array( $input ) && isset($output[$key]) ) {
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'infocenter' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'infocenter' ),
		'repeat-y'  => __( 'Repeat Vertically', 'infocenter' ),
		'repeat'    => __( 'Repeat All', 'infocenter' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'infocenter' ),
		'top center'    => __( 'Top Center', 'infocenter' ),
		'top right'     => __( 'Top Right', 'infocenter' ),
		'center left'   => __( 'Middle Left', 'infocenter' ),
		'center center' => __( 'Middle Center', 'infocenter' ),
		'center right'  => __( 'Middle Right', 'infocenter' ),
		'bottom left'   => __( 'Bottom Left', 'infocenter' ),
		'bottom center' => __( 'Bottom Center', 'infocenter' ),
		'bottom right'  => __( 'Bottom Right', 'infocenter')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'infocenter' ),
		'fixed'  => __( 'Fixed in Place', 'infocenter')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'infocenter' ),
		'italic'      => __( 'Italic', 'infocenter' ),
		'bold'        => __( 'Bold', 'infocenter' ),
		'bold italic' => __( 'Bold Italic', 'infocenter' )
		);
