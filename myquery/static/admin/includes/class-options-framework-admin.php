...
class Options_Framework_Admin {
    ...
    function settings_init() {
		...
		register_setting( "vpanel", INFOCENTER_OPTIONS,  array ( $this, 'validate_options' ) );
	...
	function vpanel_add_admin() {
		add_theme_page('Theme Settings', 'Theme Options' ,'install_themes', 'options' , array( $this, 'options_page' ),"dashicons-admin-site" );
	...
	function enqueue_admin_scripts() {
		...
		wp_localize_script("ahmed","confirm_reports",__("If you press will delete report !","infocenter"));
		wp_localize_script("ahmed","confirm_delete_attachment",__("If you press will delete the attachemtn !","infocenter"));
		wp_localize_script("ahmed","confirm_reset",__("Click OK to reset. Any theme settings will be lost!","infocenter"));
		wp_enqueue_script("infocenter_more",OPTIONS_FRAMEWORK_DIRECTORY .'js/more.js',array('jquery'));
		wp_localize_script("infocenter_more","vpanel_name","vpanel_".INFOCENTER_THEME_DATA);
		...
		wp_enqueue_script("infocenter_checkbox",OPTIONS_FRAMEWORK_DIRECTORY .'js/checkbox.min.js',array('jquery'));
		wp_localize_script("infocenter_checkbox","images_url",OPTIONS_FRAMEWORK_DIRECTORY. 'images/');
		wp_enqueue_script("infocenter_tipsy.js",OPTIONS_FRAMEWORK_DIRECTORY .'js/jquery.tipsy.js',array('jquery'));
		...
		<div id="optionsframework-wrap">
		    <form action="options.php" id="main_options_form" method="post">
				<div class="optionsframework-header">
					...
					<input type="submit" class="button-primary vpanel_save" name="update" value="<?php esc_attr_e( 'Save Options', 'infocenter' ); ?>">
					<div class="vpanel_social">
						<ul>
							<li><a class="vpanel_social_f" href="#" target="_blank"><i class="dashicons dashicons-facebook"></i></a></li>
				...
				<div class="optionsframework-content">
				    ...
				    <div id="optionsframework-metabox" class="metabox-holder">
					    <div id="optionsframework" class="postbox">
							...
							<div id="ajax-saving"><i class="dashicons dashicons-yes"></i><?php _e("Saving","infocenter")?></div>
							<div id="ajax-reset"><i class="dashicons dashicons-info"></i><?php _e("Reseting Options","infocenter")?></div>
						</div> <!-- / #container -->
					</div>
				...
				<div class="optionsframework-footer">
					<input type="submit" class="button-primary vpanel_save" name="update" value="<?php esc_attr_e( 'Save Options', 'infocenter' ); ?>">
					<div id="loading"></div>
					<input type="submit" class="reset-button button-secondary" id="reset_c" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'infocenter' ); ?>">
					<div class="clear"></div>
				</div>
			</form>
		</div> <!-- / .wrap -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'infocenter' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'infocenter' ), 'updated fade' );
	}
