jQuery(document).ready( function($) {
	...
	/* Meta box (Sidebar) */
	var sidebar_layout_m = jQuery("input[name='infocenter_sidebar']:checked").val();
	if (sidebar_layout_m == "full") {
		jQuery("#infocenter_what_sidebar").parent().parent().parent().hide(10);
	}else {
		jQuery("#infocenter_what_sidebar").parent().parent().parent().show(10);
	}
	
	jQuery("input[name='infocenter_sidebar']").change(function () {
		var sidebar_layout_c_m = jQuery(this).val();
		if (sidebar_layout_c_m == "full") {
			jQuery("#infocenter_what_sidebar").parent().parent().parent().slideUp(500);
		}else {
			jQuery("#infocenter_what_sidebar").parent().parent().parent().slideDown(500);
		}
	});
	
	var custom_page_setting = jQuery("#infocenter_custom_page_setting:checked").length;
	if (custom_page_setting == 1) {
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().show(10);
		jQuery("#infocenter_post_meta_s").parent().parent().show(10);
		jQuery("#infocenter_post_share_s").parent().parent().show(10);
		jQuery("#infocenter_post_author_box_s").parent().parent().show(10);
		jQuery("#infocenter_related_post_s").parent().parent().show(10);
		jQuery("#infocenter_post_comments_s").parent().parent().show(10);
		jQuery("#infocenter_post_navigation_s").parent().parent().show(10);
	}else {
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().hide(10);
		jQuery("#infocenter_post_meta_s").parent().parent().hide(10);
		jQuery("#infocenter_post_share_s").parent().parent().hide(10);
		jQuery("#infocenter_post_author_box_s").parent().parent().hide(10);
		jQuery("#infocenter_related_post_s").parent().parent().hide(10);
		jQuery("#infocenter_post_comments_s").parent().parent().hide(10);
		jQuery("#infocenter_post_navigation_s").parent().parent().hide(10);
	}
	jQuery("#infocenter_custom_page_setting").click(function () {
		var custom_page_setting = jQuery("#infocenter_custom_page_setting:checked").length;
		if (custom_page_setting == 1) {
			jQuery("#infocenter_sticky_sidebar_s").parent().parent().slideDown(500);
			jQuery("#infocenter_post_meta_s").parent().parent().slideDown(500);
			jQuery("#infocenter_post_share_s").parent().parent().slideDown(500);
			jQuery("#infocenter_post_author_box_s").parent().parent().slideDown(500);
			jQuery("#infocenter_related_post_s").parent().parent().slideDown(500);
			jQuery("#infocenter_post_comments_s").parent().parent().slideDown(500);
			jQuery("#infocenter_post_navigation_s").parent().parent().slideDown(500);
		}else {
			jQuery("#infocenter_sticky_sidebar_s").parent().parent().slideUp(500);
			jQuery("#infocenter_post_meta_s").parent().parent().slideUp(500);
			jQuery("#infocenter_post_share_s").parent().parent().slideUp(500);
			jQuery("#infocenter_post_author_box_s").parent().parent().slideUp(500);
			jQuery("#infocenter_related_post_s").parent().parent().slideUp(500);
			jQuery("#infocenter_post_comments_s").parent().parent().slideUp(500);
			jQuery("#infocenter_post_navigation_s").parent().parent().slideUp(500);
		}
	});
	...
	if (post_type == "post") {
		jQuery("#infocenter_page_builder").parent().parent().remove();
		jQuery("#infocenter_post_author_box_s").parent().parent().remove();
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().remove();
	}else if (post_type == "question") {
		jQuery("#infocenter_page_builder").parent().parent().remove();
		jQuery("#infocenter_post_meta_s").parent().parent().remove();
		jQuery("label[for='infocenter_what_post']").parent().parent().remove();
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().remove();
	}else if (post_type == "page") {
		jQuery("#infocenter_page_builder").parent().parent().remove();
		jQuery("#infocenter_post_share_s").parent().parent().remove();
		jQuery("#infocenter_post_navigation_s").parent().parent().remove();
		jQuery("#infocenter_post_author_box_s").parent().parent().remove();
		jQuery("#infocenter_related_post_s").parent().parent().remove();
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().remove();
	}else if (post_type == "product") {
		jQuery("#infocenter_page_builder").parent().parent().remove();
		jQuery("#infocenter_post_meta_s").parent().parent().remove();
		jQuery("#infocenter_post_author_box_s").parent().parent().remove();
		jQuery("#infocenter_post_comments_s").parent().parent().remove();
		jQuery("#infocenter_sticky_sidebar_s").parent().parent().remove();
	}
	...
	jQuery("#infocenter_google").parent().parent().hide(10);
	jQuery("#infocenter_video_post_type").parent().parent().parent().hide(10);
	jQuery("#infocenter_video_post_id").parent().parent().hide(10);
	jQuery("#infocenter_video_mp4").parent().parent().hide(10);
	jQuery("#infocenter_video_m4v").parent().parent().hide(10);
	jQuery("#infocenter_video_webm").parent().parent().hide(10);
	jQuery("#infocenter_video_ogv").parent().parent().hide(10);
	jQuery("#infocenter_video_wmv").parent().parent().hide(10);
	jQuery("#infocenter_video_flv").parent().parent().hide(10);
	jQuery("#infocenter_video_image").parent().parent().parent().hide(10);
	jQuery("#infocenter_slideshow_type").parent().parent().parent().hide(10);
	jQuery("[data-field_id='infocenter_upload_images']").parent().parent().hide();
	
	var builder_slide_warp = jQuery("#builder_slide_warp").html();
	jQuery("#builder_slide_warp").remove();
	jQuery("#infocenter_slideshow_post").html(builder_slide_warp).hide(10);
	if (jQuery("#infocenter_slideshow_post").length > 0) {
		jQuery("#infocenter_slideshow_post ul").sortable({placeholder: "ui-state-highlight"});
	}
	
	var builder_rating_warp = jQuery("#builder_rating_warp").html();
	jQuery("#builder_rating_warp").remove();
	jQuery("#infocenter_ratings_post").html(builder_rating_warp);
	if (jQuery("#infocenter_ratings_post").length > 0) {
		jQuery("#infocenter_ratings_post ul").sortable({placeholder: "ui-state-highlight"});
	}
	
	jQuery("#infocenter_slideshow_type").change(function () {
		var slideshow_type = jQuery(this).val();
		if (slideshow_type == "custom_slide") {
			jQuery("#infocenter_slideshow_post").slideDown(500);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideUp(500);
		}else {
			jQuery("#infocenter_slideshow_post").slideUp(500);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideDown(500);
		}
	});
	jQuery("#infocenter_what_post").change(function () {
		var what_post = jQuery(this).val();
		if (what_post == "google") {
			jQuery("#infocenter_google").parent().parent().slideDown(500);
			jQuery("#infocenter_video_post_type").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_video_post_id").parent().parent().slideUp(500);
			jQuery("#infocenter_video_mp4").parent().parent().slideUp(500);
			jQuery("#infocenter_video_m4v").parent().parent().slideUp(500);
			jQuery("#infocenter_video_webm").parent().parent().slideUp(500);
			jQuery("#infocenter_video_ogv").parent().parent().slideUp(500);
			jQuery("#infocenter_video_wmv").parent().parent().slideUp(500);
			jQuery("#infocenter_video_flv").parent().parent().slideUp(500);
			jQuery("#infocenter_video_image").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_slideshow_type").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_slideshow_post").slideUp(500);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideUp(500);
		}else if (what_post == "slideshow") {
			jQuery("#infocenter_google").parent().parent().slideUp(500);
			jQuery("#infocenter_video_post_type").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_video_post_id").parent().parent().slideUp(500);
			jQuery("#infocenter_video_mp4").parent().parent().slideUp(500);
			jQuery("#infocenter_video_m4v").parent().parent().slideUp(500);
			...
			jQuery("#infocenter_video_flv").parent().parent().slideUp(500);
			jQuery("#infocenter_video_image").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_slideshow_type").parent().parent().parent().slideDown(500);
			jQuery("#infocenter_slideshow_post").slideUp(500);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideUp(500);
			
			var infocenter_slideshow_type = jQuery("#infocenter_slideshow_type").val();
			if (infocenter_slideshow_type == "custom_slide") {
				jQuery("#infocenter_slideshow_post").slideDown(500);
				jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideUp(500);
			}else {
				jQuery("#infocenter_slideshow_post").slideUp(500);
			...
			jQuery("#infocenter_google").parent().parent().slideUp(500);
			jQuery("#infocenter_video_post_type").parent().parent().parent().slideDown(500);
			
			var infocenter_slideshow_type = jQuery("#infocenter_video_post_type").val();
			if (infocenter_slideshow_type == "html5") {
				jQuery("#infocenter_video_mp4").parent().parent().slideDown(500);
				jQuery("#infocenter_video_m4v").parent().parent().slideDown(500);
				jQuery("#infocenter_video_webm").parent().parent().slideDown(500);
				jQuery("#infocenter_video_ogv").parent().parent().slideDown(500);
				jQuery("#infocenter_video_wmv").parent().parent().slideDown(500);
				jQuery("#infocenter_video_flv").parent().parent().slideDown(500);
				jQuery("#infocenter_video_image").parent().parent().parent().slideDown(500);
			}else {
				jQuery("#infocenter_video_post_id").parent().parent().slideDown(500);
			}
			jQuery("#infocenter_slideshow_type").parent().parent().parent().slideUp(500);
			jQuery("#infocenter_slideshow_post").slideUp(500);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().slideUp(500);
	...
	var infocenter_what_post = jQuery("#infocenter_what_post").val();
	var infocenter_slideshow_type = jQuery("#infocenter_slideshow_type").val();

	if (infocenter_what_post == "google") {
		jQuery("#infocenter_google").parent().parent().show(10);
	}else if (infocenter_what_post == "slideshow") {
		jQuery("#infocenter_slideshow_type").parent().parent().parent().show(10);
		if (infocenter_slideshow_type == "custom_slide") {
			jQuery("#infocenter_slideshow_post").show(10);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().hide();
		}else {
			jQuery("#infocenter_slideshow_post").hide(10);
			jQuery("[data-field_id='infocenter_upload_images']").parent().parent().show(10);
		}
	}else if (infocenter_what_post == "video") {
		jQuery("#infocenter_video_post_type").parent().parent().parent().show(10);
		if (jQuery("#infocenter_video_post_type").val() == "html5") {
			jQuery("#infocenter_video_mp4").parent().parent().show(10);
			jQuery("#infocenter_video_m4v").parent().parent().show(10);
			jQuery("#infocenter_video_webm").parent().parent().show(10);
			jQuery("#infocenter_video_ogv").parent().parent().show(10);
			jQuery("#infocenter_video_wmv").parent().parent().show(10);
			jQuery("#infocenter_video_flv").parent().parent().show(10);
			jQuery("#infocenter_video_image").parent().parent().parent().show(10);
			jQuery("#infocenter_video_post_id").parent().parent().hide(10);
		}else {
			jQuery("#infocenter_video_post_id").parent().parent().show(10);
			jQuery("#infocenter_video_mp4").parent().parent().hide(10);
			jQuery("#infocenter_video_m4v").parent().parent().hide(10);
			jQuery("#infocenter_video_webm").parent().parent().hide(10);
			jQuery("#infocenter_video_ogv").parent().parent().hide(10);
		...
		jQuery("#infocenter_video_post_type").change(function () {
			jQuery("#infocenter_video_post_type").parent().parent().parent().slideDown(500);
			if (jQuery("#infocenter_video_post_type").val() == "html5") {
				jQuery("#infocenter_video_mp4").parent().parent().slideDown(500);
				jQuery("#infocenter_video_m4v").parent().parent().slideDown(500);
	...
	if (jQuery("#infocenter_post_display_b").val() == "multiple_categories") {
		jQuery("label[for='infocenter_post_categories_b']").parent().parent().show(10);
		jQuery("label[for='infocenter_post_single_category_b'],label[for='infocenter_post_posts_b']").parent().parent().hide(10);
	}else if (jQuery("#infocenter_post_display_b").val() == "single_category") {
		jQuery("label[for='infocenter_post_single_category_b']").parent().parent().show(10);
		jQuery("label[for='infocenter_post_categories_b'],label[for='infocenter_post_posts_b']").parent().parent().hide(10);
	}else if (jQuery("#infocenter_post_display_b").val() == "posts") {
		jQuery("label[for='infocenter_post_posts_b']").parent().parent().show(10);
		jQuery("label[for='infocenter_post_categories_b'],label[for='infocenter_post_single_category_b']").parent().parent().hide(10);
	}else {
		jQuery("label[for='infocenter_post_single_category_b'],label[for='infocenter_post_categories_b'],label[for='infocenter_post_posts_b']").parent().parent().hide(10);
	}
	
	jQuery("#infocenter_post_display_b").change(function () {
		if (jQuery(this).val() == "multiple_categories") {
			jQuery("label[for='infocenter_post_categories_b']").parent().parent().slideDown(500);
			jQuery("label[for='infocenter_post_single_category_b'],label[for='infocenter_post_posts_b']").parent().parent().slideUp(500);
		}else if (jQuery(this).val() == "single_category") {
			jQuery("label[for='infocenter_post_single_category_b']").parent().parent().slideDown(500);
			jQuery("label[for='infocenter_post_categories_b'],label[for='infocenter_post_posts_b']").parent().parent().slideUp(500);
		}else if (jQuery(this).val() == "posts") {
			jQuery("label[for='infocenter_post_posts_b']").parent().parent().slideDown(500);
			jQuery("label[for='infocenter_post_categories_b'],label[for='infocenter_post_single_category_b']").parent().parent().slideUp(500);
		}else {
			jQuery("label[for='infocenter_post_single_category_b'],label[for='infocenter_post_categories_b'],label[for='infocenter_post_posts_b']").parent().parent().slideUp(500);
		}
	});
	...
	var custom_sections = jQuery("#infocenter_custom_sections:checked").length;
	if (custom_sections == 1) {
		jQuery("#sort-sections").show(10);
	}else {
		jQuery("#sort-sections").hide(10);
	}
	jQuery("#infocenter_custom_sections").click(function () {
		var custom_sections = jQuery("#infocenter_custom_sections:checked").length;
		if (custom_sections == 1) {
	...
	}else if (page_template == "knowledgebase/infotex_home.php") {
		jQuery("#ask_me").show(10);
	}else if (page_template == "knowledgebase/infotex_home_two.php") {
		jQuery("#ask_me").show(10);
	}else {
	...
	if (page_template == "template-home.php") {
		jQuery("#post_page").hide(10);
	}else if (page_template == "knowledgebase/infotex_home.php") {
		jQuery("#post_page").hide(10);
	}else if (page_template == "knowledgebase/infotex_home_two.php") {
		jQuery("#post_page").hide(10);
	}else {
		jQuery("#post_page").show(10);
	}
	...
	if (page_template == "template-blog_2.php") {
		jQuery("#blog").show(10);
	}else {
		jQuery("#blog").hide(10);
	}
	...
	jQuery("#page_template").change(function () {
		...
		if (page_template == "template-home.php") {
		jQuery("#post_page").slideUp(10);
		}else if (page_template == "knowledgebase/infotex_home.php") {
			jQuery("#post_page").slideUp(10);
		}else if (page_template == "knowledgebase/infotex_home_two.php") {
			jQuery("#post_page").slideUp(10);
		}else {
			jQuery("#post_page").slideDown(10);
		}
	...
	if (jQuery("#infocenter_index_tabs").val() == 1) {
		jQuery("label[for='infocenter_what_tab'],label[for='infocenter_pagination_tabs'],label[for='infocenter_posts_per_page']").parent().parent().slideDown(500);
	}else if (jQuery("#infocenter_index_tabs").val() == 2) {
		jQuery("label[for='infocenter_posts_per_page']").parent().parent().slideDown(500);
		jQuery("label[for='infocenter_what_tab'],label[for='infocenter_pagination_tabs']").parent().parent().slideUp(500);
	}else {
		jQuery("label[for='infocenter_what_tab'],label[for='infocenter_pagination_tabs'],label[for='infocenter_posts_per_page']").parent().parent().slideUp(500);
	}
	
	jQuery("#infocenter_index_tabs").change(function () {
		if (jQuery("#infocenter_index_tabs").val() == 1) {
			jQuery("label[for='infocenter_what_tab'],label[for='infocenter_pagination_tabs'],label[for='infocenter_posts_per_page']").parent().parent().slideDown(500);
		}else if (jQuery("#infocenter_index_tabs").val() == 2) {
			jQuery("label[for='infocenter_posts_per_page']").parent().parent().slideDown(500);
	...
	if (jQuery(".rwmb-input input[value='custom_image'][name='infocenter_header_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='display_code'][name='infocenter_header_adv_type']:checked").length == 0) {
		jQuery("#infocenter_header_adv_img").parent().parent().slideDown(500);
		jQuery("#infocenter_header_adv_href").parent().parent().slideDown(500);
		jQuery("#infocenter_header_adv_code").parent().parent().hide(10);
	}else if (jQuery(".rwmb-input input[value='display_code'][name='infocenter_header_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='custom_image'][name='infocenter_header_adv_type']:checked").length == 0) {
		jQuery("#infocenter_header_adv_code").parent().parent().slideDown(500);
		jQuery("#infocenter_header_adv_img").parent().parent().hide(10);
		jQuery("#infocenter_header_adv_href").parent().parent().hide(10);
	}
    jQuery(".rwmb-input input[value='custom_image'][name='infocenter_header_adv_type']").click(function () {
    	jQuery("#infocenter_header_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_header_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_header_adv_code").parent().parent().slideUp(500);
    });
    jQuery(".rwmb-input input[value='display_code'][name='infocenter_header_adv_type']").click(function () {
    	jQuery("#infocenter_header_adv_img").parent().parent().slideUp(500);
    	jQuery("#infocenter_header_adv_href").parent().parent().slideUp(500);
    	jQuery("#infocenter_header_adv_code").parent().parent().slideDown(500);
    });
    ...
    if (jQuery(".rwmb-input input[value='custom_image'][name='infocenter_share_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='display_code'][name='infocenter_share_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_share_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_share_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_share_adv_code").parent().parent().hide(10);
    }else if (jQuery(".rwmb-input input[value='display_code'][name='infocenter_share_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='custom_image'][name='infocenter_share_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_share_adv_code").parent().parent().slideDown(500);
    	jQuery("#infocenter_share_adv_img").parent().parent().hide(10);
    	jQuery("#infocenter_share_adv_href").parent().parent().hide(10);
    }
    jQuery(".rwmb-input input[value='custom_image'][name='infocenter_share_adv_type']").click(function () {
    	jQuery("#infocenter_share_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_share_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_share_adv_code").parent().parent().slideUp(500);
    });
    jQuery(".rwmb-input input[value='display_code'][name='infocenter_share_adv_type']").click(function () {
    	jQuery("#infocenter_share_adv_img").parent().parent().slideUp(500);
    	jQuery("#infocenter_share_adv_href").parent().parent().slideUp(500);
    	jQuery("#infocenter_share_adv_code").parent().parent().slideDown(500);
    });
    ...
    if (jQuery(".rwmb-input input[value='custom_image'][name='infocenter_related_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='display_code'][name='infocenter_related_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_related_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_related_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_related_adv_code").parent().parent().hide(10);
    }else if (jQuery(".rwmb-input input[value='display_code'][name='infocenter_related_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='custom_image'][name='infocenter_related_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_related_adv_code").parent().parent().slideDown(500);
    	jQuery("#infocenter_related_adv_img").parent().parent().hide(10);
    	jQuery("#infocenter_related_adv_href").parent().parent().hide(10);
    }
    jQuery(".rwmb-input input[value='custom_image'][name='infocenter_related_adv_type']").click(function () {
    	jQuery("#infocenter_related_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_related_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_related_adv_code").parent().parent().slideUp(500);
    });
    jQuery(".rwmb-input input[value='display_code'][name='infocenter_related_adv_type']").click(function () {
    	jQuery("#infocenter_related_adv_img").parent().parent().slideUp(500);
    	jQuery("#infocenter_related_adv_href").parent().parent().slideUp(500);
    	jQuery("#infocenter_related_adv_code").parent().parent().slideDown(500);
    });
    ...
    if (jQuery(".rwmb-input input[value='custom_image'][name='infocenter_content_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='display_code'][name='infocenter_content_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_content_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_content_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_content_adv_code").parent().parent().hide(10);
    }else if (jQuery(".rwmb-input input[value='display_code'][name='infocenter_content_adv_type']:checked").length > 0 && jQuery(".rwmb-input input[value='custom_image'][name='infocenter_content_adv_type']:checked").length == 0) {
    	jQuery("#infocenter_content_adv_code").parent().parent().slideDown(500);
    	jQuery("#infocenter_content_adv_img").parent().parent().hide(10);
    	jQuery("#infocenter_content_adv_href").parent().parent().hide(10);
    }
    jQuery(".rwmb-input input[value='custom_image'][name='infocenter_content_adv_type']").click(function () {
    	jQuery("#infocenter_content_adv_img").parent().parent().slideDown(500);
    	jQuery("#infocenter_content_adv_href").parent().parent().slideDown(500);
    	jQuery("#infocenter_content_adv_code").parent().parent().slideUp(500);
    });
    jQuery(".rwmb-input input[value='display_code'][name='infocenter_content_adv_type']").click(function () {
    	jQuery("#infocenter_content_adv_img").parent().parent().slideUp(500);
    	jQuery("#infocenter_content_adv_href").parent().parent().slideUp(500);
    	jQuery("#infocenter_content_adv_code").parent().parent().slideDown(500);
    });
