...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'rwmb', RWMB_CSS_URL . 'rwmb-infocenter-style.css', array(), RWMB_VER );
				...
				echo '
					...
					if ( typeof rwmb == "undefined" )
					{
						var rwmb = {
							...
							summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'infocenter' ) . '"
						};
					}
					else
					{
