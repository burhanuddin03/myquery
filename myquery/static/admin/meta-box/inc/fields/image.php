...
if ( ! class_exists( 'RWMB_Image_Field' ) )
{
	class RWMB_Image_Field extends RWMB_File_Field
	{
		...
		{
			$i18n_title = apply_filters( 'rwmb_image_upload_string', esc_html_x( 'Upload Images', 'image upload', 'infocenter' ), $field );
			$i18n_more  = apply_filters( 'rwmb_image_add_string', esc_html_x( '+ Add new image', 'image upload', 'infocenter' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_image_delete_string', esc_html_x( 'Delete', 'image upload', 'infocenter' ) );
			$i18n_edit   = apply_filters( 'rwmb_image_edit_string', esc_html_x( 'Edit', 'image upload', 'infocenter' ) );
			$li = '
				<li id="item_%s">
					<img src="%s" />
