	...
	class RWMB_File_Advanced_Field extends RWMB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'rwmb-file-advanced', 'rwmbFileAdvanced', array(
				'frameTitle' => __( 'Select Files', 'infocenter' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'rwmb_file_advanced_select_string', esc_html_x( 'Select or Upload Files', 'file upload', 'infocenter' ), $field );
