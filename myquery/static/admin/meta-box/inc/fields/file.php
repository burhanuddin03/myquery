	...
	class RWMB_File_Field extends RWMB_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'rwmb-file', 'rwmbFile', array(
				'maxFileUploadsSingle' => __( 'You may only upload maximum %d file', 'infocenter' ),
				'maxFileUploadsPlural' => __( 'You may only upload maximum %d files', 'infocenter' ),
			) );
		}
		...
		static function wp_ajax_delete_file()
		{
			...
			if ( $ok )
				...
				wp_send_json_error( __( 'Error: Cannot delete file', 'infocenter' ) );
		}
		...
		{
			$i18n_title = apply_filters( 'rwmb_file_upload_string', esc_html_x( 'Upload Files', 'file upload', 'infocenter' ), $field );
			$i18n_more  = apply_filters( 'rwmb_file_add_string', esc_html_x( '+ Add new file', 'file upload', 'infocenter' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_file_delete_string', esc_html_x( 'Delete', 'file upload', 'infocenter' ) );
			$i18n_edit   = apply_filters( 'rwmb_file_edit_string', esc_html_x( 'Edit', 'file upload', 'infocenter' ) );
			$li = '
			<li>
