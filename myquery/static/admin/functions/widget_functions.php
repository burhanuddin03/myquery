...
function widgets_init() {
	...
	$footer_layout = INFOCENTER_OPTIONS("footer_layout");
	$before_widget = '<div id="%1$s" class="widget %2$s">';
	$after_widget = '</div>';
	$before_title = '<h3 class="widget_title">';
	$after_title = '</h3>';
	if ($footer_layout == "footer_1c" || $footer_layout == "footer_2c" || $footer_layout == "footer_3c" || $footer_layout == "footer_4c" || $footer_layout == "footer_5c" || $footer_layout == "footer_top") {
		register_sidebar( array(
			'name' => __("The Top footer widget area","infocenter"),
	...
	if ($footer_layout == "footer_1c" || $footer_layout == "footer_2c" || $footer_layout == "footer_3c" || $footer_layout == "footer_4c" || $footer_layout == "footer_5c") {
		register_sidebar( array(
		'name' => __("The first footer widget area","infocenter"),
		...
		if ($footer_layout == "footer_2c" || $footer_layout == "footer_3c" || $footer_layout == "footer_4c" || $footer_layout == "footer_5c") {
			register_sidebar( array(
		'name' => __("The Second footer widget area","infocenter"),
		...
		if ($footer_layout == "footer_3c" || $footer_layout == "footer_4c" || $footer_layout == "footer_5c") {
			register_sidebar( array(
			'name' => __("The Third footer widget area","infocenter"),
	...
	if ($footer_layout == "footer_4c" || $footer_layout == "footer_5c") {
		register_sidebar( array(
			'name' => __("The Fourth footer widget area","infocenter"),
