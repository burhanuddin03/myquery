<?php /* Template Name: Home Page - Style 3*/
get_header();
?>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div id="posts-masonry" class="posts-masonry">
                     <?php $st_categories = get_categories($infotex_hp2_cat_args); 
				...
				?>
					 ...
					 <div class="<?php if ($knowledgehome2_sidebar_on_off == 1) { ?>col-md-6 col-sm-6 col-xs-12<?php } else { ?>col-md-4 col-sm-6 col-xs-12<?php } ?>">
                        <div class="site-map">
                           <div class="cat-title">
                               <h3><a href="<?php echo get_category_link( $st_category->term_id ); ?>"><?php echo esc_attr($st_category->name); ?></a></h3>
                               <span><i class="fa fa-folder-o" aria-hidden="true"></i></span>
                           </div>
                           <ul class="site-map-list">
						   <?php $cat_query = new WP_Query(array('order'=> $knowledgehome2_articles_asc_desc, 'cat' => $cat_id, 'orderby' => 'post_date', 'posts_per_page'   => $knowledgehome2_posts_per_page ));
                           ...
                           <a class="read-more" href="<?php echo get_category_link( $st_category->term_id ); ?>"><?php if ($knowledgehome2_category_button_label != '') { ?><?php echo esc_attr($knowledgehome2_category_button_label); ?><?php } else { ?><?php esc_html_e("View all Articles","infocenter");?><?php } ?></a>
                        </div>
                        <!-- .site-map -->
                     </div>
					 <?php if ($knowledgehome2_sidebar_on_off == 1) { ?>
